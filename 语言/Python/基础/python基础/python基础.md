...
*4.最后：就让我们从这些标准开始研究，开启我们的socket编程之旅*![img](_attachments/22ed55c591a270855509e9e3e459a8df.jpg)
​                                                           图1
...
![img](_attachments/5a8cad4c4f145a40366ce966a8ee438a.jpg)
...
![img](_attachments/3e0bce9e4ef2868b3c4db85968daeaac.jpg)      
...
![img](_attachments/aeeffa09a60bc1037ae69a2856cf8941.png)
...
![img](_attachments/e4a07d3049f29e57fd7388eba63333d3.png)

客户端1运行结果

![img](_attachments/1943ec3d57b70a232d2018cf0e37e08c.png)

客户端2运行结果

![img](_attachments/7155547e909af9bc03d6164356b83ef4.png)
...
![img](_attachments/b45b005dfd1207f7aeb572260a8486c5.png)
...
![img](_attachments/c7289986b7942bc5de0eeab5beccdb76.png)
...
![img](_attachments/e73c9e1090d3b7d057f0865b139b9df2.png)

request类：

![img](_attachments/9a406eb68472226d77adb8bacb861fcb.png)

继承关系:

![img](_attachments/5d083d789c328e006a2dc1f1de0336b4.png)

![img](_attachments/ed9794c3ac120278b2da61255e870c20.png)

 

 ![img](_attachments/7b0744fcf4166a5d6a2d930dc45a3186.png)
...
![img](_attachments/1c53668bcee393edac0d7b3b3daff1ae.gif) 事件驱动之鼠标点击事件注册
...
4. 事件（消息）一般都各自保存各自的处理函数指针，这样，每个消息都有独立的处理函数； 
   ![这里写图片描述](_attachments/20161012022913536)
   **事件驱动编程是一种编程范式，这里程序的执行流由外部事件来决定。它的特点是包含一个事件循环，当外部事件发生时使用回调机制来触发相应的处理**。另外两种常见的编程范式是（单线程）同步以及多线程编程。 
   　
   让我们用例子来比较和对比一下单线程、多线程以及事件驱动编程模型。下图展示了随着时间的推移，这三种模式下程序所做的工作。这个程序有3个任务需要完成，每个任务都在等待I/O操作时阻塞自身。阻塞在I/O操作上所花费的时间已经用灰色框标示出来了。 
   ![这里写图片描述](_attachments/20161012023013850)
...
![img](_attachments/fcb1407b1fcf214338059effb9f9a74a.gif)
...
![img](_attachments/c2bfaf6db3063791be8005315ef4ba3d.gif)
...
![img](_attachments/19f7d84669b868795cc21cc72f104ea7.gif)
...
![img](_attachments/e8d324f01a338db2df25cf084019f4f1.gif)
...
![img](_attachments/b07a5622bdf1937191e5e2c3b696bc7f.gif)

​      经过上面的介绍，会发现non-blocking IO和asynchronous IO的区别还是很明显的。在non-blocking IO中，虽然进程大部分时间都不会被block，但是它仍然要求进程去主动的check，并且当数据准备完成以后，也需要进程主动的再次调用recvfrom来将数据拷贝到用户内存。而asynchronous IO则完全不同。它就像是用户进程将整个IO操作交给了他人（kernel）完成，然后他人做完后发信号通知。在此期间，用户进程不需要去检查IO操作的状态，也不需要主动的去拷贝数据。

五种IO模型比较：

​      ![img](_attachments/c281e336b451455ac3275b53a9cce11b.png) 
...
![img](_attachments/582b440cb7d9e8708e303929f2d56950.png)
